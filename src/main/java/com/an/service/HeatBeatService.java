...
import com.an.entity.resp.BaseResp;

public class HeatBeatService extends AbstractService<HeatBeat, BaseResp> {

    @Override
    protected BaseResp doService(HeatBeat heatBeat) {
        return new BaseResp();
    }
